...
| D13 | One primary-emphasis button per screen; the main action is last in its group.                                                                                                                                                                                                                                                                        | Review; the Button stories show the pattern; the Button weights and contrast in `docs/decisions.md` ("Buttons") and `packages/tokens/src/contrast.ts` (the build fails below 4.5:1)                                                                                                             |
