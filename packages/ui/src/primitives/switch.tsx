 ...
 * Disabled: surface.disabled. The thumb moves along the inline axis, so it starts at the
  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        'data-[state=checked]:bg-brand-solid disabled:cursor-not-allowed disabled:bg-surface-disabled',
        FOCUS_RING,
        className,
      )}
      {...props}
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none absolute start-[2.5px] block size-3.5 rounded-full bg-current text-on-accent transition-[inset-inline-start] duration-(--liro-duration-base) ease-standard data-[state=checked]:start-[21.5px]"
      />
    </SwitchPrimitive.Root>
  )
}
