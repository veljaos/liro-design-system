...
/**
 * A checkbox (shadcn/ui checkbox, adapted; Mantine Checkbox.css, size 'sm'): 20px, radius md,
...
export function Checkbox({ className, ...props }: ComponentProps<typeof CheckboxPrimitive.Root>) {
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        BUTTON_RESET,
        'peer relative inline-flex size-5 shrink-0 cursor-pointer items-center justify-center rounded-md border border-solid border-control bg-surface-raised text-on-accent transition-colors duration-(--liro-duration-fast) ease-standard after:absolute after:-inset-0.5',
